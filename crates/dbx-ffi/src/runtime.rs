...
//!
//! It is **process-global** rather than per-[`crate::DbxCore`] on purpose:
//!
...
fn build() -> Result<Runtime, String> {
    ...
    tokio::runtime::Builder::new_multi_thread()
        ...
        .thread_name("dbx-worker")
        .enable_all()
        .build()
        .map_err(|e| format!("could not start the dbx runtime: {e}"))
}
