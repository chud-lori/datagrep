//! Errors from the MongoShell parser (design §3.6: "dbx supports query
...
pub enum MongoError {
    ...
    #[error("dbx supports query expressions, not arbitrary JavaScript — use a raw command document for anything else")]
    UnsupportedJs,
