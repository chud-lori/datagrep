...
use dbx_api::driver::{Batch, Payload};
use dbx_api::shape::{FieldDef, FieldFlags, LogicalType, RowSchema, SchemaDelta, Shape};
...
pub struct StoreState {
    ...
    pub notices: Vec<dbx_api::driver::Notice>,
