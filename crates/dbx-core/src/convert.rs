...
//!
//! Everything below `dbx-api` speaks `Vec<Value>`; everything at and above the
...
use dbx_api::driver::Row;
use dbx_api::shape::{LogicalType, RowSchema};
use dbx_api::value::{Geometry, TzSpec, Value};
...
mod tests {
    ...
    use bytes::Bytes;
    use dbx_api::shape::{FieldDef, FieldFlags};
    use dbx_api::value::Document;
