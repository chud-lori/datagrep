//! # dbx-core — the only stateful orchestrator (design §3)
//!
...
//! frontends consume.
//!
//! The load-bearing invariants, all from `dbx-design.md`:
//!
...
//!   [`dbx_api::DbError::DriverPanic`], and the connection is poisoned and
