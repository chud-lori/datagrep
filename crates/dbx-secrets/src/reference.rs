...
mod tests {
    ...
    #[test]
    fn parses_keychain() {
        let r: SecretRef = "keychain:dbx:prod-pg/admin".parse().unwrap();
        assert_eq!(
            r,
            SecretRef::Keychain {
                service: "dbx".into(),
    ...
    fn keychain_account_may_contain_colons() {
        ...
        let r: SecretRef = "keychain:dbx:acct:with:colons".parse().unwrap();
        assert_eq!(
            r,
            SecretRef::Keychain {
                service: "dbx".into(),
