...
use dbx_api::{DbError, FieldPath, ObjectPath, PathSeg, Predicate, ResumeToken, SortKey, Value};
...
/// `dbx-api`'s [`FieldPath`] allows nested/indexed paths (`a.b[3]`) for
